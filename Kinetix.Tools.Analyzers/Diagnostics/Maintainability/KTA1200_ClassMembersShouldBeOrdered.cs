...
namespace Kinetix.Tools.Analyzers.Diagnostics.Maintainability
{
    /// <summary>
    ...
    public class KTA1200_ClassMembersShouldBeOrdered : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "KTA1200";
