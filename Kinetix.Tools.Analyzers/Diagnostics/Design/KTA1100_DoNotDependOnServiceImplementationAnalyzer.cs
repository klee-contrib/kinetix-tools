...
namespace Kinetix.Tools.Analyzers.Diagnostics.Design
{
    ...
    public class KTA1100_DoNotDependOnServiceImplementationAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "KTA1100";
        ...
        private static void AnalyzeSymbol(SymbolAnalysisContext context)
        {
            ...
            foreach (var parameter in method.Parameters)
            {
                ...
                if (paramType is not INamedTypeSymbol paramClass || !paramClass.IsServiceImplementation())
                {
                    continue;
                }
