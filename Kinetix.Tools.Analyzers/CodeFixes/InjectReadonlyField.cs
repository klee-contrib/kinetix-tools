...
namespace Kinetix.Tools.Analyzers.CodeFixes
{
    ...
    public class InjectReadonlyField : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(KTA1103_ReadonlyFieldsShouldBeInjected.DiagnosticId);
        ...
        private static async Task<Document> InjecterComposant(Document document, VariableDeclaratorSyntax champ, CancellationToken jetonAnnulation)
        {
            ...
            var nouveauConstructeur = constructeur
                ...
                .WithLeadingTrivia(
                    constructeur.GetLeadingTrivia()
                        .Select(i =>
                        {
                            return i.GetStructure() is not DocumentationCommentTriviaSyntax doc
                                ? i
            ...
            var nouvelleRacine = Formatter.Format(racine.ReplaceNode(constructeur, nouveauConstructeur), document.Project.Solution.Workspace, cancellationToken: jetonAnnulation);
