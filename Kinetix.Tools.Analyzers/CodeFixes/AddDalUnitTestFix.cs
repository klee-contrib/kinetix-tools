...
using Kinetix.Tools.Analyzers.Diagnostics.Coverage;
...
namespace Kinetix.Tools.Analyzers.CodeFixes
{
    ...
    public class AddDalUnitTestFix : CodeFixProvider
    {
        ...
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(KTA1300_DalMethodWithSqlServerCommandAnalyser.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            if (methDecl.Parent is not ClassDeclarationSyntax classDecl)
            {
                return;
            }
